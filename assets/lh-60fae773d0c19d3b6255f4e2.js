...
var $this = jQuery(this);
    function initSlide(){
         let data = {
          ...
          loop: section.settings.loop == 'yes',
          navigation: {
...
$_this.find('.count_time').on('time.elapsed', function () {
 ...
 };						cb.bind($('section[data-section-id="3XtP0oA5gW"] include[data-name="countdown"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
...
var current_variant = null;
 ...
 };						cb.bind($('section[data-section-id="3XtP0oA5gW"] include[data-name="product-form"][data-id="3"]').get(0))(jQuery);;var cb  = function($) {
  var $this = jQuery(this);
 ...
 };						cb.bind($('section[data-section-id="3XtP0oA5gW"] include[data-name="tabs"][data-id="5"]').get(0))(jQuery);;var cb  = function($) {
 ...
 };						cb.bind($('section[data-section-id="3XtP0oA5gW"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="3XtP0oA5gW"]').get(0))({						url: "https://library.layouthub.com/HUB/files/Tm92LS0yMDE5/NTc0ODY0ODc5/First_release/pages/Gime/product/",						settings: {"trans_label_dd":"day","trans_label_hh":"hrs","trans_label_mm":"min","trans_label_ss":"sec","trans_unavai":"Unavailable","trans_outstock":"Launching Soon!"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "ybcwqok5c1"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="ybcwqok5c1"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/A86iQazbFCg9LR3W/banner/",						settings: {}					}, jQuery);})(jQuery);;console.log('This page layout has been built by https://www.layouthub.com');