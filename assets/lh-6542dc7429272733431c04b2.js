...
var current_variant = null;
 ...
 };						cb.bind($('section[data-section-id="l66b45phmfn"] include[data-name="product-form"][data-id="2"]').get(0))(jQuery);;var cb  = function($) {
...
if(document.querySelector('.page-container')){
 ...
 };						cb.bind($('section[data-section-id="l66b45phmfn"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="l66b45phmfn"]').get(0))({						url: "https://library.layouthub.com/HUB/files/Tm92LS0yMDE5/NTc0ODY0ODc5/First_release/pages/Yogmat/product-detail/",						settings: {"trans_unavai":"Unavailable","trans_outstock":"Out of stock"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "ydnbugn6p8"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="ydnbugn6p8"]').get(0))({						url: "https://library.layouthub.com/HUB/files/U2VwLS0yMDIw/NTk5NDQ1MzA1/shopify-third-release/pages/fDRqnaNOgGdC41kh/reason/",						settings: {}					}, jQuery);})(jQuery);;console.log('This page layout has been built by https://www.layouthub.com');